"""
25. Use raw_input() to take user input - a 4-digit year. Reject the input with a polite
message if it is not all digits. Looping through the Fama-French_data.txt file,
calculate the average MktRF value for that year.
